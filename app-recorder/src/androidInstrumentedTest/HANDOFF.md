...
Runs `:app-recorder:connectedDebugAndroidTest -PminimalGlSources=true` on an API 34 `aosp_atd` emulator (KVM). Triggers on every push. On failure, uploads test reports.
