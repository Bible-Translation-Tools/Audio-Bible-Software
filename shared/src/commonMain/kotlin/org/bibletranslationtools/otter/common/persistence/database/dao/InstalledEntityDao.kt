...
/**
 * The clean DAO contract for the installed_entity table (no jOOQ `DSLContext` parameter). The
 * SQLDelight backend implements this directly, with atomicity handled inside the implementation.
 */
interface InstalledEntityDao {
