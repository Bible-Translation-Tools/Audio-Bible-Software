...
class ContainerUnitTest {
    ...
    fun `load rc with uncommon extension`() {
        ...
        // File.createTempFile, not kotlin.io.createTempFile: the latter is deprecated at ERROR
        // level from Kotlin 1.8 onward (world-readable temp files), and this repo builds with 2.4.
        val rcFile = File(sourceRC)
            .copyTo(File.createTempFile("rc-test", ".orature"), overwrite = true)
        rcFile.deleteOnExit()
