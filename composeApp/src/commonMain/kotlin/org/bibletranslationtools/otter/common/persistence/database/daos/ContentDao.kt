...
import org.bibletranslationtools.otter_db.jooq.tables.ContentDerivative
import org.jooq.*
...
class ContentDao(
    ...
    fun selectLinkableVerses(
        ...
        return dsl
            ...
            .from(main)
            .join(help)
            .on(main.COLLECTION_FK.eq(help.COLLECTION_FK))
            .and(main.START.eq(help.START))
    ...
    fun selectLinkableChapters(
        ...
        return dsl
            ...
            .from(main)
            .join(help)
            .on(help.COLLECTION_FK.eq(main.ID))
