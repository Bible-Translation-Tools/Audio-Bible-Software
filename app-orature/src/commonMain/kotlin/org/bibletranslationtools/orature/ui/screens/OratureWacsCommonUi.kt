...
/**
 * M5(a): Orature's port of the recorder app's `WacsCommonUi.kt` — shared between
 * [OratureWacsPublishScreen] and [OratureWacsPullScreen], both of which gate on
 * [org.bibletranslationtools.otter.common.domain.wacs.WacsPlatform.isGitSyncSupported] and, before
 * that, need the same M1 login form. Extracted here rather than duplicated so the two screens
 * can't silently drift on copy or behavior.
 */
@Composable
